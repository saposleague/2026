...
function createNotificationOptions(data) {
  return {
    body: data.body,
    icon: data.icon || 'https://saposleague.github.io/teste/images/web-app-manifest-192x192.png',
    badge: data.badge || 'https://saposleague.github.io/teste/images/favicon-96x96.png',
    tag: data.tag,
    vibrate: [200, 100, 200],
    ...
    actions: [
      {
        action: 'view',
        title: '👀 Ver',
        icon: 'https://saposleague.github.io/teste/images/favicon-96x96.png'
      },
      {
        action: 'close',
        title: '❌ Fechar',
