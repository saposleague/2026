...
- No celular, as sugestões do editor de peladas agora são exibidas no fluxo do formulário, logo abaixo do campo.
- O menu deixou de depender de `position: fixed` e do viewport instável do Safari com o teclado aberto.
- O comportamento flutuante já estável foi preservado no desktop.

### 2.2.49 — 19/08/2026

- As sugestões do jogador adicionado passam a acompanhar o campo durante a abertura do teclado e a rolagem do modal.
- A nova linha é centralizada automaticamente antes da digitação no celular.

### 2.2.48 — 19/08/2026

- A posição das sugestões no editor de peladas agora considera a altura real da lista.
- Listas com poucos nomes permanecem alinhadas ao campo editado mesmo com o teclado aberto no celular.

### 2.2.47 — 19/08/2026

- As sugestões de jogadores na edição de peladas agora aparecem sobre o modal e funcionam no celular.
- A linha criada por `Adicionar Jogador` passou a usar o mesmo layout responsivo dos demais jogadores.

### 2.2.46 — 19/08/2026

- Contraste reforçado no modo claro dos modais de consulta e edição da Gestão de Peladas.
- Campos, etiquetas de status e botões de filtrar, editar, excluir, remover e salvar ficaram mais legíveis.

### 2.2.45 — 19/08/2026

- Gerador de Times permite até um empréstimo por time quando faltarem jogadores.
- O nível do `Jogador X estrelas` é escolhido entre níveis reais existentes em outros times da pelada.
- Resumo, cópia e exportação identificam os empréstimos sem cadastrá-los ou registrar presença.

### 2.2.44 — 19/08/2026

- Cadastro e edição de jogadores agora bloqueiam nomes duplicados.
- A comparação ignora maiúsculas, acentos, espaços extras e diferenças de formatação.
- A validação também foi aplicada na Cloud Function administrativa antes da gravação no Supabase.

### 2.2.43 — 17/08/2026

- Contraste dos avisos de vagas e goleiros corrigido no tema claro do Gerador de Times.

### 2.2.42 — 17/08/2026

- Contraste do tema claro reforçado no Gerador de Times e na Gestão de Jogadores.
- Cards, campos, listas, estados desabilitados e textos auxiliares ficaram mais legíveis.

### 2.2.41 — 17/08/2026

- Campos de data e horário da Gestão de Rodadas corrigidos para respeitar a largura do formulário no Safari/iPhone.

### 2.2.40 — 17/08/2026

- Contraste estrutural do tema claro reforçado na Gestão de Rodadas.
- Fundo, card principal, campos, divisórias e blocos de confronto ficaram mais definidos.

### 2.2.39 — 14/08/2026

- Contraste do bloco de confirmação de nomes corrigido no tema claro.
- Opções disponíveis e jogadores já selecionados permanecem legíveis em estados distintos.

### 2.2.38 — 14/08/2026

- Contraste do resultado da importação de jogadores corrigido no tema claro.
- Status exato, aproximação e confirmado agora usam textos escuros e fundos mais definidos.
...
- Contraste dos textos do tema claro corrigido na Gestão de Rodadas.
- Rótulos, subtítulo, destaque do título e orientações ficaram mais legíveis no celular.
